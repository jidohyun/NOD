...
class Settings(BaseSettings):
    ...
    VIDEO_TRANSCRIPT_PROXY_HTTP_URL: str | None = None
    VIDEO_TRANSCRIPT_PROXY_HTTPS_URL: str | None = None
    VIDEO_TRANSCRIPT_PROXY_WEBSHARE_USERNAME: str | None = None
    VIDEO_TRANSCRIPT_PROXY_WEBSHARE_PASSWORD: str | None = None
    VIDEO_TRANSCRIPT_PROXY_WEBSHARE_LOCATIONS: str = ""
    VIDEO_TRANSCRIPT_PROXY_RETRIES_WHEN_BLOCKED: int = 10
