...
_LANG_CONFIG: dict[str, dict[str, str]] = {
    ...
    "es": {
        "name": "Spanish",
        "native": "Español",
        "summary_heading": "Resumen clave",
        "detail_heading": "Detalles",
        "code_heading": "Fragmentos de código (solo partes clave)",
        "insight_heading": "Ideas / Acciones",
    },
    "pt-BR": {
        "name": "Portuguese (Brazil)",
        "native": "Português",
        "summary_heading": "Resumo principal",
        "detail_heading": "Detalhes",
        "code_heading": "Trechos de código (apenas partes-chave)",
        "insight_heading": "Insights / Ações",
    },
    "zh-CN": {
        "name": "Chinese (Simplified)",
        "native": "中文",
        "summary_heading": "核心摘要",
        "detail_heading": "详细内容",
        "code_heading": "代码片段 (仅关键部分)",
        "insight_heading": "洞察 / 待办事项",
    },
    "de": {
        "name": "German",
        "native": "Deutsch",
        "summary_heading": "Kernzusammenfassung",
        "detail_heading": "Details",
        "code_heading": "Code-Ausschnitte (nur Kernteile)",
        "insight_heading": "Erkenntnisse / Maßnahmen",
    },
    "fr": {
        "name": "French",
        "native": "Français",
        "summary_heading": "Résumé clé",
        "detail_heading": "Détails",
        "code_heading": "Extraits de code (parties clés uniquement)",
        "insight_heading": "Idées / Actions",
    },
}
