    ...
    <article className="prose" itemScope itemType="https://schema.org/Article">
      ...
      <div className="space-y-8 text-[15px] leading-relaxed text-cm-text/80">
        ...
        <section>
          ...
          <p className="mt-4">
            If you primarily work with PDFs, <strong className="text-cm-text">Scholarcy</strong> and{" "}
            <strong className="text-cm-text">SciSummary</strong> are strong choices. If you discover
            ...
            <strong className="text-cm-text">Elicit</strong> stands out by letting you ask specific
        ...
        <section>
          ...
          <h3 className="mb-2 mt-6 text-lg font-semibold text-cm-text">1. Section-aware parsing</h3>
          <p>
          ...
          <p>
            ...
            discussion section. <strong className="text-cm-text">Always verify AI summaries</strong>{" "}
        ...
        <section>
          ...
          <ol className="mt-4 space-y-4 pl-5">
            ...
            <li>
              <strong className="text-cm-text">Step 4: Save and organize with tags/concepts</strong>{" "}
