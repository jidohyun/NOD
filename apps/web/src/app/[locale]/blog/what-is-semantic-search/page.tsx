    ...
    <article className="prose" itemScope itemType="https://schema.org/Article">
      ...
      <div className="space-y-8 text-[15px] leading-relaxed text-cm-text/80">
        ...
        <section>
          ...
          <p className="mt-4">
            <strong className="text-cm-text">Semantic search</strong> changes everything. Instead of
        ...
        <section>
          ...
          <p>
            ...
            the <strong className="text-cm-text">cosine similarity</strong> between your query
            vector and every document vector in the database. Documents with the highest similarity
            scores are returned as results.
          </p>
          <p className="mt-3">
        ...
        <section>
          ...
          <div className="mt-6 rounded-xl border border-cm-text/10 bg-cm-mint/20 p-5">
            ...
            <p className="mt-2 text-sm">
              You search for:{" "}
              <span className="text-nod-gold">&ldquo;machine learning performance tips&rdquo;</span>
            </p>
            <p className="mt-2 text-sm">
        ...
        <section>
          ...
          <p>
            ...
            synthesized answer. This is how tools like Perplexity AI and ChatGPT&apos;s web browsing
            work.
          </p>
        ...
        <section className="rounded-xl border cm-doodle-border border-nod-gold/20 bg-nod-gold/5 p-6">
          <h2 className="mb-3 text-xl font-bold text-cm-text">The Future of Search Is Semantic</h2>
          <p>
