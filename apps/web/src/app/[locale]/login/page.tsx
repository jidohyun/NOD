...
import { signInWithGoogle, getSupabase } from "@/lib/auth/auth-client";
      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex justify-center mb-8">
          <div className="w-12 h-12 rounded-lg bg-nod-gold flex items-center justify-center">
            <span className="font-display font-bold text-lg text-[#0A0A0B] tracking-tight">
              N
            </span>
          </div>
        </div>
        ...
        <div className="bg-nod-surface-raised border border-nod-border rounded-xl p-8">
          ...
          >
            ...
            <span>
              {signingIn ? t("login.signingIn") : t("continueWithGoogle")}
            </span>
          </button>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-2 bg-nod-surface-raised text-white/30">
                {t("login.or")}
              </span>
            </div>
          </div>
